...
export default function Oldbridge100years({ navigation }) {
      ...
      <ScrollView>
        <View style={styles.container}>
            ...
            <ViewSlider
              renderSlides={
                <>
                  ...
                  <View style={styles.viewBox}>
                    <Image
                      source={require("../src/assets/oldbridge100years1.jpg")}
                      style={{ height: 200, width }}
                    />
                  </View>
                  <View style={styles.viewBox}>
                    <Image
                      source={require("../src/assets/oldbridge100years2.jpg")}
                      style={{ height: 200, width }}
                    />
                  </View>
                </>
                    ...
                    <View style={styles.contentContainer}>
                      ...
                      >
                        <View style={styles.contentIcon}>
                          <Text style={styles.contentBtnTxt}>10.สะพานคอย 100 ปี</Text>
          ...
          <MapView
            style={styles.map}
            initialRegion={{
              latitude: 6.2618284982782715,
              longitude: 102.05509217326158,
              latitudeDelta: 0.1,
              longitudeDelta: 0.1,
            }}
          >
            <Marker
              coordinate={{ latitude: 6.2618284982782715, longitude: 102.05509217326158}}
              pinColor="#f37721"
            >
              <Callout>
                <Text>สะพานอยู่ตรงนี่</Text>
              </Callout>
            </Marker>
          </MapView>
        </View>
