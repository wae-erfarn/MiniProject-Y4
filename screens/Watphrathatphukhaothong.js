...
export default function Watphrathatphukhaothong({ navigation }) {
      ...
      <ScrollView>
        <View style={styles.container}>
            ...
            <ViewSlider
              renderSlides={
                <>
                  ...
                  <View style={styles.viewBox}>
                    <Image
                      source={require("../src/assets/watphrathatphukhaothong1.jpg")}
                      style={{ height: 200, width }}
                    />
                  </View>
                  <View style={styles.viewBox}>
                    <Image
                      source={require("../src/assets/watphrathatphukhaothong2.jpg")}
                      style={{ height: 200, width }}
                    />
                  </View>
                </>
          ...
          <MapView
            style={styles.map}
            initialRegion={{
              latitude: 5.800353502812507,
              longitude: 101.75961499847271,
              latitudeDelta: 0.1,
              longitudeDelta: 0.1,
            }}
          >
            <Marker
              coordinate={{ latitude: 5.800353502812507, longitude: 101.75961499847271}}
              pinColor="#f37721"
            >
              <Callout>
                <Text>วัดอยู่ตรงนี่</Text>
              </Callout>
            </Marker>
          </MapView>
        </View>
