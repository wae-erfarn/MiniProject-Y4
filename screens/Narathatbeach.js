...
export default function Narathatbeach({ navigation }) {
      ...
      <ScrollView>
        <View style={styles.container}>
            ...
            <ViewSlider
              renderSlides={
                <>
                  ...
                  <View style={styles.viewBox}>
                    <Image
                      source={require("../src/assets/narathatbeach1.jpg")}
                      style={{ height: 200, width }}
                    />
                  </View>
                  <View style={styles.viewBox}>
                    <Image
                      source={require("../src/assets/narathatbeach2.jpg")}
                      style={{ height: 200, width }}
                    />
                  </View>
                </>
                    ...
                    <View style={styles.contentContainer}>
                      ...
                      >
                        <View style={styles.contentIcon}>
                          <Text style={styles.contentBtnTxt}>5.หาดนราทัศน์</Text>
                    ...
                    <View style={styles.contentContainer}>
                      ...
                      >
                        <View style={styles.contentIcon1}>
                          ...
                          <Text style={styles.contenthistoryBtnTxt}><Text style={{fontWeight: 'bold'}}>ประวัติความเป็นมา : </Text><Text style={styles.contenthistoryBtnTxt1}> ตั้งอยู่ในตัวเมืองนราธิวาส เป็นชายหาดที่มีความสวยงาม โค้งหาดยาวต่อเนื่องประมาณ 5 กิโลเมตร มองเห็นได้ไกลจนสุดลูกหูลูกตา จรดกกับปลายแหลมปากแม่น้ำบางนราทางทิศใต้ เป็นหาดที่มีความสวยงาม หาดทรายขาว  ร่มรื่นด้วยทิวสนมากมาย อีกทั้งยังมีลมพัดเย็นบรรยากาศเป็นส่วนตัว ทำให้หาดนราทัศน์เป็นสถานที่พักผ่อนหย่อนใจของชาวเมืองนราธิวาส และนักท่องเที่ยวที่มาเยือนเสมอ ยังมีหมู่บ้านชาวประมงตั้งกระจายเป็นระยะ ๆ ชายหาดช่วงที่อยู่ด้านหน้าหมู่บ้านจะมีเรือนกอและจอดเรียงรายอย่างสวยงาม โดยเฉพาะลักษณะของเรือกอและที่มีการวาดลวยลายอันวิจิตร ซึ่งเป็นวัฒนธรรมของชาวใต้ ริมหาดนี้ยังมีร้านอาหารเรียงรายอยู่หลายร้าน ใต้แนวสนที่ร่มรื่นยังเหมาะแก่การตั้งแค้มป์ รวมถึงมีบังกะโลริมหาดสำหรับผู้ที่ต้องการพักค้างคืนอยู่</Text>
                        </Text></View>
                      </View>
                    </View>
          ...
          <MapView
            style={styles.map}
            initialRegion={{
              latitude: 6.447122804539493,
              longitude: 101.82427546817887,
              latitudeDelta: 0.1,
              longitudeDelta: 0.1,
            }}
          >
            <Marker
              coordinate={{ latitude: 6.447122804539493, longitude: 101.82427546817887}}
              pinColor="#f37721"
            >
              <Callout>
                <Text>หาดอยู่ตรงนี้</Text>
              </Callout>
            </Marker>
          </MapView>
        </View>
