...
export default function Pajowaterfall({ navigation }) {
      ...
      <ScrollView>
        <View style={styles.container}>
            ...
            <ViewSlider
              renderSlides={
                <>
                  ...
                  <View style={styles.viewBox}>
                    <Image
                      source={require("../src/assets/pajowaterfall1.jpg")}
                      style={{ height: 200, width }}
                    />
                  </View>
                  <View style={styles.viewBox}>
                    <Image
                      source={require("../src/assets/pajowaterfall2.jpg")}
                      style={{ height: 200, width }}
                    />
                  </View>
                </>
                    ...
                    <View style={styles.contentContainer}>
                      ...
                      >
                        <View style={styles.contentIcon}>
                          <Text style={styles.contentBtnTxt}>7.น้ำตกปาโจ</Text>
                     ...
                     <View style={styles.contentContainer}>
                      ...
                      >
                        <View style={styles.contentIcon2}>
                          ...
                          <Text style={styles.contenthistoryBtnTxt}><Text style={{fontWeight: 'bold'}}>สถานที่ : </Text><Text style={styles.contenthistoryBtnTxt1}> ตำบลบาเจาะ อำเภอบาเจาะ จังหวัดนราธิวาส</Text>
                        </Text></View>
                      </View>
                    </View>
          ...
          <MapView
            style={styles.map}
            initialRegion={{
              latitude: 6.497936257491888,
              longitude: 101.63438172832372,
              latitudeDelta: 0.1,
              longitudeDelta: 0.1,
            }}
          >
            <Marker
              coordinate={{ latitude: 6.497936257491888, longitude: 101.63438172832372}}
              pinColor="#f37721"
            >
              <Callout>
                <Text>น้ำตกอยู่ตรงนี้</Text>
              </Callout>
            </Marker>
          </MapView>
        </View>
